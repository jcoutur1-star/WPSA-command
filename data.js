...
const ALL_HERO_DEFS=[
  ...
  {id:15,title:"Seraph",realName:"Unknown",basePower:8.6,baseHP:70,career:"beginner",cls:"cannon",regenSec:18,functionalAt:20,personality:"Ancient warrior who carries the Gauntlets of Light. Calm, otherworldly, occasionally cryptic, and seems to know about events between angels and demons.",abilities:"Divine energy blasts, healing light, flight, temporal slow field.",weaknesses:"Dark magic. Corruption-based attacks.",affiliates:["The Crimson Knight","Cassonik"],specialAbility:"Celestial Aura: +1.0 power for both when fighting alongside The Crimson Knight.",shopLocked:true,baseAvail:true,color:"#ff8844"},
  // UNLOCKABLE IN-GAME
  ...
  {id:59,title:"Corvair",realName:"Dakota Jasup",isFemale:true,basePower:1.1,baseHP:45,career:"beginner",cls:"support",regenSec:10,functionalAt:25,personality:"A bubbly and kind hero who really shouldn't be on our roster. She has mild powers of friendship, and we can't actually tell if it's a superpower or if she's just really positive and friendly. Regardless, we feel like we can't cut her now...",abilities:"Has the ability to make anyone happier.",weaknesses:"Extremely susceptible to all forms of damage.",affiliates:["The Dragon of the Daimyo"],specialAbility:"Somewhere I Belong: upon reaching veteran, all heroes gain a boost of +0.5 to their power level.",shopLocked:true,baseAvail:true,color:"#44ff88"},
...
const VILLAIN_DEFS=[
  ...
  {id:106,title:"Niera",realName:"Allison Basque",basePower:7.9,baseHP:89,career:"beginner",cls:"tank",regenSec:34,functionalAt:5,personality:"Ruthless combat extremist. Loyal to those who earn her respect. She seems most impressed by the indomitable will of The Crimson Knight and the overhwhelming restraint of John, preferring to primarily associate with them.",abilities:"Extreme durability, extreme physical prowess, possible magic.",weaknesses:"Susceptible to persuasion. Vulnerable to illusions.",affiliates:["The Crimson Knight","John"],specialAbility:"Dedication: all heroes alongside her gain +20 HP.",redeemable:true,threatType:"military",loc:"Brussels",x:240,y:72,reward:40},
