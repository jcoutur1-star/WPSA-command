...
const GOLDEN_AGE_DEFS=[
  {title:"Captain Shamrock (Hughes)",status:"Deceased",realName:"Liam Hughes",basePower:8.5,baseHP:90,career:"intermediate",cls:"tank",regenSec:15,functionalAt:10,personality:"A rock. An absolute foundation of strength, sturdiness, and patience. He trained Styles and Elegus into some of the greatest to ever do it. Both have called him the GOAT of their heart.",abilities:"Extreme proficiency with the Shield of Shamrock.",weaknesses:"Human without the shield.",affiliates:["Trekken","Wildcard","Magnetrix","Lamentia","Hydromous","Fats","The Anchor","Seraph","Elegus","Captain Shamrock (Styles)"],specialAbility:"Can save any hero from death except for himself, leaving them at 1 hp.",portrait:"portraits/Hughes.jpg"},
  {title:"Trekken",status:"Deceased",realName:"Janice Ormund",basePower:5.0,baseHP:40,career:"beginner",cls:"support",regenSec:3,functionalAt:5,personality:"A fast talking, slick, and speedy personality.",abilities:"A true speedster, capable of moving at incredible speeds — faster than most bullets.",weaknesses:"Low durability. Sonic booms can hurt her ears.",affiliates:["Captain Shamrock (Hughes)","Wildcard","Magnetrix","Lamentia","Hydromous","Fats","The Anchor","Seraph"],specialAbility:"Now you see me? 15% chance of taking no damage on a mission.",portrait:"portraits/Trekken.jpg"},
