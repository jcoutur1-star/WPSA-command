...
// ─── SHOP-LOCKED HEROES ───────────────────────────────────────────────────────
const SHOP_LOCK_TITLES=["The Anchor","Greywulf","Ironside","Pyrexa","Seraph","Big Mack","Scarlett","Corvair","Dr. Voidance","Mycenzo","The Conductor","Shadowmere"];
...
const SHOP_VILLAIN_TITLES=["The Vicountess","Dr. Stinkenstein","Hydrotheppilies","Professor Cyanide","Chelikere","Kinetica","Quaker"];
...
const CP={
  ...
  "The Dragon of the Daimyo":["YAAAAS let's GO!","You see that? Yeah? That's ten thousands viewers watching me save the day","Dragon mode: unlocked!","I practiced this transformation for weeks.","Someone clip this for Twitter.","The character arc is so real right now.","My ancestors are SCREAMING right now and it's for the right reasons!","Okay but my dragon form is literally so aesthetic.","Tell me I'm not the main character. I dare you.","I'm going to do a little victory dance whether you like it or not.","Slay. Literally. For real.","No no no, hold on — I need to pose for the cameras first.","You should've seen my mom's dragon form...","My mom is going to see this and she's going to lose her mind.","Time for a team up episode! Hope my best friends can be there!","The comments are going to go INSANE for this one.","Bestie behavior only on this team. Periodt."],
  ...
  "Quaker":["I'm working on it. Truly. I am.","I am trying so hard not to hurt anyone.","The Lord grant me steadiness. Any steadiness at all.","If the ground shakes, that's on me. I'm so sorry."],
