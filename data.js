...
// ─── CATCHPHRASES ─────────────────────────────────────────────────────────────
const CP={
  "The Crimson Knight":["For faith and the fallen!","The sword of virtue never dulls.","God's grace and iron will.","Stand firm — knights do not run.","Fine, I'll take out this bad guy but I have a date in 10 minutes","I would die for this world. Let's hope it doesn't come to that.","Every battle is a prayer answered by action.","John… be safe out there.","I have faced darkness before. This is just another Tuesday.","The shield is raised. Let them come.","Virtue is not a burden — it's an armor.","I am not afraid. I have never been afraid.","My sword has never failed the innocent.","Every soul is worth protecting. Every single one.","The Order didn't make me. I made the Order."],
...
const STATIC_REL={"The Crimson Knight|John":"romantically involved","John|The Crimson Knight":"dating","The Sportsman|Morgana":"married","Morgana|The Sportsman":"married","IceBerg|John":"close friends","The Flip|Adrenaline Junkie":"mentor/mentee","The Flip|Dinosia":"research collaborators","The Vicountess|Dr. Stinkenstein":"married","Dr. Stinkenstein|The Vicountess":"married","Professor Cyanide|Greg":"married (Greg is a civilian)"};
...
const ALL_HERO_DEFS=[
  ...
  {id:59,title:"Corvair",realName:"Dakota Jasup",isFemale:true,basePower:1.1,baseHP:45,career:"beginner",cls:"support",regenSec:10,functionalAt:25,personality:"A bubbly and kind hero who really shouldn't be on our roster. She has mild powers of friendship, and we can't actually tell if it's a superpower or if she's just really positive and friendly.",abilities:"Has the ability to make anyone happier.",weaknesses:"Extremely susceptible to all forms of damage.",affiliates:["The Dragon of the Daimyo"],specialAbility:"Somewhere I Belong: upon reaching veteran, all heroes gain a boost of +0.5 to their power level.",shopLocked:true,baseAvail:true,color:"#44ff88"},
...
function buildCodexEntries(){
  const entries=[];
  ALL_HERO_DEFS.forEach(h=>entries.push({id:"h_"+h.id,category:"hero",name:h.title,realName:h.realName,cls:h.cls,power:h.basePower,hp:h.baseHP,personality:h.personality,abilities:h.abilities,weaknesses:h.weaknesses,special:h.specialAbility,secret:h.hiddenTraits?h.secretTrait:null}));
