...
const VILLAIN_DEFS=[
  ...
  {id:102,title:"Maniac",realName:"Unknown",basePower:8.3,baseHP:90,career:"veteran",cls:"tank",regenSec:50,functionalAt:1,personality:"Chaos entity. Seeks only destruction. Lone Wolf.",abilities:"Extreme durability/strength, fire/magma control, wind control, flight.",weaknesses:"Susceptible to magic.",specialAbility:"TRUE POWER HIDDEN: sensors under-read this threat.",hiddenPower:true,redeemable:false,threatType:"military",loc:"Unknown",lat:5.0,lng:-5.0,reward:60},
  {id:103,title:"Silphana",realName:"Alexandria Aeros",basePower:8.0,baseHP:65,career:"beginner",cls:"tank",regenSec:35,functionalAt:20,personality:"Former WSPA asset who joined the Knights of Darkness.",abilities:"The Mace of the Corrupted, high durability, speed, strength, dark magic.",weaknesses:"Power waning due to corruption.",affiliates:[],specialAbility:"Mace of the Corrupted deals 10× damage to The Crimson Knight. Once redeemed: Mace deals 10× damage against supervillains.",redeemable:true,threatType:"military",loc:"Eastern Europe",lat:50.0,lng:25.0,reward:55,portrait:"portraits/Silphana.jpg"},
  ...
  {id:106,title:"Niera",realName:"Allison Basque",basePower:7.9,baseHP:80,career:"beginner",cls:"tank",regenSec:34,functionalAt:5,personality:"Ruthless combat extremist. Loyal to those who earn her respect. She seems most impressed by the indomitable will of The Crimson Knight and the overhwhelming restraint of John, preferring to primarily associate with them.",abilities:"Extreme durability, extreme physical prowess, possible magic.",weaknesses:"Susceptible to persuasion. Vulnerable to illusions.",affiliates:["The Crimson Knight","John"],specialAbility:"Dedication: all heroes alongside her gain +20 HP.",redeemable:true,threatType:"military",loc:"Brussels",lat:50.8,lng:4.4,reward:40,portrait:"portraits/Niera.jpg"},
...
const ALL_THREATS=[
  ...
  {id:222,name:"THE LOCH NESS MONSTER",loc:"Loch Ness, Scotland",lat:57.3,lng:-4.4,priority:"orange",type:"kaiju",desc:"The legendary leviathan has finally surfaced.",maxTimer:250,reward:40,isOcean:true,isKaiju:true,unlockHero:"Captain Shamrock"},
  ...
  {id:252,name:"Division 8",loc:"Unknown",lat:5.0,lng:-5.0,priority:"red",type:"military",desc:"A splinter faction of Division 7, dedicated to destroying both the world and Division 7. Outstanding commitment.",maxTimer:190,reward:50,recurring:true},
  ...
  {id:264,name:"REAPER: ENTITY OF DARKNESS",loc:"Unknown",lat:5.0,lng:-5.0,priority:"red",type:"mystic",desc:"An entity of darkness who deals 45 damage to all support heroes. Avoid deploying support classes.",maxTimer:195,reward:58,reaperEffect:true},
  ...
  {id:290,name:"EVIL HACKERS",loc:"Unknown",lat:5.0,lng:-5.0,priority:"orange",type:"tech",desc:"An elite network of evil hackers is systematically dismantling global infrastructure.",maxTimer:260,reward:32,recurring:true},
  // ── V7 NEW THREATS ──
  ...
  {id:294,name:"NBA Franchise Owners",loc:"New York, USA",lat:40.7,lng:-74.0,priority:"orange",type:"military",desc:"The NBA franchise owners have taken civilians hostage and are forcing them to watch their dying sport. Attendance is at an all-time low and they are desperate.",maxTimer:310,reward:26,isNorthAmerica:true},
