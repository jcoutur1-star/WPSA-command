...
const GENERIC_IDLE_HEADLINES=[
  ...
  "Elegus explains why it's so hard to answer Golden Age GOAT Debate",
...
const GOLDEN_AGE_DEFS=[
  {title:"Captain Shamrock (Hughes)",status:"Deceased",realName:"Liam Hughes",basePower:8.5,baseHP:90,career:"intermediate",cls:"tank",regenSec:15,functionalAt:10,personality:"A rock. An absolute foundation of strength, sturdiness, and patience.",abilities:"Extreme proficiency with the Shield of Shamrock.",weaknesses:"Human without the shield.",affiliates:["The Anchor","Seraph","Trekken","Lamentia"],specialAbility:"Can save any hero from death except for himself, leaving them at 1 hp.",portrait:"portraits/Hughes.jpg"},
  {title:"Trekken",status:"Deceased",realName:"Janice Ormund",basePower:5.0,baseHP:40,career:"beginner",cls:"support",regenSec:3,functionalAt:5,personality:"A fast talking, slick, and speedy personality.",abilities:"A true speedster, capable of moving at incredible speeds — faster than most bullets.",weaknesses:"Low durability. Sonic booms can hurt her ears.",affiliates:["Captain Shamrock (Hughes)","Wildcard","Elegus","Lamentia"],specialAbility:"Now you see me? 15% chance of taking no damage on a mission.",portrait:"portraits/Trekken.jpg"},
  {title:"Wildcard",status:"Killed in action — sacrificed herself to save The Anchor",realName:"Vanessa Stock",basePower:5.3,baseHP:45,career:"beginner",cls:"support",regenSec:15,functionalAt:20,personality:"A wily and reckless trickster with a heart of gold. Rather flirtatious with her teammates.",abilities:"Capable of drawing from a power list that includes heightened speed, strength, and durability, but only one at a time.",weaknesses:"She can only use one ability at a time.",affiliates:["The Anchor","Captain Shamrock (Hughes)"],specialAbility:"Able to save any affiliate from dying, leaving them at 1hp. Cannot save herself.",portrait:"portraits/Wildcard.jpg"},
  {title:"Magnetrix",status:"Deceased",realName:"Elizabeth Audi",basePower:3.9,baseHP:45,career:"beginner",cls:"support",regenSec:7,functionalAt:20,personality:"A sweet, caring woman with exceptional medicinal skills.",abilities:"Medicinal powers capable of keeping heroes in the fight.",weaknesses:"Ordinary human durability.",affiliates:["Captain Shamrock (Hughes)","Trekken"],specialAbility:"Pulse: full health restore of all heroes every 5 minutes.",portrait:"portraits/Magnetrix.jpg"},
  {title:"Lamentia",status:"Deceased",realName:"Raven Sett",basePower:7.8,baseHP:78,career:"beginner",cls:"cannon",regenSec:35,functionalAt:14,personality:"A brilliant, cunning woman with a real enjoyment for the game.",abilities:"Extremely powerful void magic. Capable of opening rifts to other dimensions and discharging a dark energy blast.",weaknesses:"Arrogance.",affiliates:["Captain Shamrock (Hughes)","Trekken"],specialAbility:"Used to the darkness: If Lamentia is about to die, 50/50 chance she evades with 15hp remaining.",portrait:"portraits/Lamentia.jpg"},
  {title:"Hydromous",status:"Deceased",realName:"Jordan P. Shrimperson",basePower:7.5,baseHP:75,career:"beginner",cls:"tank",regenSec:25,functionalAt:30,personality:"A warrior in a shrimp's body. A king of the sea unafraid of anyone or anything.",abilities:"Extreme water proficiency.",weaknesses:"Weak near heat or on land.",affiliates:["The Anchor"],specialAbility:"+1 combat power on underwater missions.",portrait:"portraits/Hydromous.jpg"},
  {title:"Fats",status:"Deceased",realName:"Michael Desco",basePower:5.5,baseHP:65,career:"beginner",cls:"tank",regenSec:25,functionalAt:5,personality:"A blunt and cunning wiseguy.",abilities:"His bones are as durable as brass.",weaknesses:"Very heavy. Water.",affiliates:["Captain Shamrock (Hughes)","Wildcard","Elegus","Lamentia"],specialAbility:"Wise guy: +.05 combat power to all heroes deployed on the same mission.",portrait:"portraits/Fats.jpg"},
];
const GOLDEN_AGE_CROSSOVER=["Seraph","The Anchor"]; // still-active heroes who also served in the Golden Age
const GOLDEN_AGE_LOST_RECORDS=["Jaxx","Echo","Solace","Burst","Bullet"]; // Golden Age deceased, few records survive
