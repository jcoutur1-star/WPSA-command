...
const ALL_HERO_DEFS=[
  ...
  {id:15,title:"Seraph",realName:"Unknown",basePower:8.3,baseHP:70,career:"beginner",cls:"cannon",regenSec:18,functionalAt:20,personality:"Ancient warrior who carries the Gauntlets of Light. Calm, otherworldly, occasionally cryptic, and seems to know about events between angels and demons.",abilities:"Divine energy blasts, healing light, flight, temporal slow field.",weaknesses:"Dark magic. Corruption-based attacks.",affiliates:["Eclipso","Cassonik"],specialAbility:"Celestial Aura: +5% Mission Success.",shopLocked:true,baseAvail:true,color:"#ff8844",portrait:"portraits/Seraph.jpg"},
  // UNLOCKABLE IN-GAME
...
const VILLAIN_DEFS=[
  ...
  {id:102,title:"Maniac",realName:"Unknown",basePower:8.3,baseHP:88,career:"veteran",cls:"tank",regenSec:50,functionalAt:1,personality:"Chaos entity. Seeks only destruction. Lone Wolf.",abilities:"Extreme durability/strength, fire/magma control, wind control, flight.",weaknesses:"Susceptible to magic.",specialAbility:"TRUE POWER HIDDEN: sensors under-read this threat.",hiddenPower:true,redeemable:false,threatType:"military",loc:"Unknown",x:300,y:160,reward:60},
