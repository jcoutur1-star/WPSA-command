...
// ─── CATCHPHRASES ─────────────────────────────────────────────────────────────
const CP={
  "The Crimson Knight":["For faith and the fallen!","The sword of virtue never dulls.","God's grace and iron will.","Stand firm — knights do not run.","Rome wasn't defended in a day, but I'll try.","I would die for this world. Let's hope it doesn't come to that.","Every battle is a prayer answered by action.","John… be safe out there.","I have faced darkness before. This is just another Tuesday.","The shield is raised. Let them come."],
...
const ALL_HERO_DEFS=[
  ...
  {id:10,title:"Greywulf",realName:"Harlan Cross",isMale:true,basePower:7.5,baseHP:88,career:"beginner",cls:"tank",regenSec:50,functionalAt:30,personality:"Gruff Montana ranger turned werewolf. Deeply uncomfortable with his condition.",abilities:"Werewolf form: extreme strength, speed, regeneration, heightened senses.",weaknesses:"Silver. Full moon renders uncontrollable.",affiliates:["The Flip","Cassonik"],specialAbility:"Pack Instinct: +0.5 power when teamed with 2+ heroes.",shopLocked:true,baseAvail:true,color:"#4488ff"},
  {id:11,title:"The Anchor",realName:"Solomon Vrey",isMale:true,basePower:8.1,baseHP:100,career:"beginner",cls:"tank",regenSec:55,functionalAt:40,personality:"Ancient Zulu warrior who cannot die of old age. Wise, deliberate.",abilities:"Absolute physical endurance, gravity manipulation, immovable stance.",weaknesses:"Painfully slow. Cannot fly. Weak to electricity.",affiliates:["Mycenzo","The Crimson Knight"],specialAbility:"Cannot be one-shot regardless of multipliers.",shopLocked:true,baseAvail:true,color:"#4488ff"},
  ...
  // ── NEW SHOP HEROES ──
  {id:57,title:"Big Mack",realName:"Mack",isMale:true,basePower:5.1,baseHP:50,career:"beginner",cls:"cannon",regenSec:39,functionalAt:25,personality:"A dependable brute. He views life in simplistic terms.",abilities:"Able to fire himself in short, powerful bursts at his foes. His high durability makes him an effective wrecking ball, but durability is charged in his blasts.",weaknesses:"After a blast, his durability and strength are reduced, and he can get nauseous.",affiliates:["The Gummy Bear"],specialAbility:"Charged Blasts: his blasts now do extra damage ×1.1.",shopLocked:true,baseAvail:true,color:"#ff8844"},
  {id:58,title:"Scarlett",realName:"Alexandria Rose",isFemale:true,basePower:2.6,baseHP:43,career:"beginner",cls:"support",regenSec:15,functionalAt:15,personality:"A smaller, less durable hero who plays as an excellent team player.",abilities:"Able to shapeshift into any other person she's seen before.",weaknesses:"Human durability. Can only hold a shape for an hour or so.",affiliates:["Adrenaline Junkie"],specialAbility:"Intel: All missions she goes on have a 10% higher success rate.",shopLocked:true,baseAvail:true,color:"#44ff88"},
  {id:59,title:"Corvair",realName:"Dakota Jasup",isFemale:true,basePower:1.1,baseHP:35,career:"beginner",cls:"support",regenSec:10,functionalAt:25,personality:"A bubbly and kind hero who really shouldn't be on our roster. She has mild powers of friendship, and we can't actually tell if it's a superpower or if she's just really positive and friendly.",abilities:"Has the ability to make anyone happier.",weaknesses:"Extremely susceptible to all forms of damage.",affiliates:["The Dragon of the Daimyo"],specialAbility:"Somewhere I Belong: upon reaching veteran, all heroes gain a boost of +0.5 to their power level.",shopLocked:true,baseAvail:true,color:"#44ff88"},
  {id:60,title:"The Dragon of the Daimyo",realName:"Sakura Kitsune",basePower:7.3,baseHP:66,career:"beginner",cls:"tank",regenSec:50,functionalAt:40,personality:"Loves anime, westerns, dancing, Kpop, Kdrama, and gaming. Is the direct descendant of an emperor, though her magic comes from her mother's line. Extremely bubbly and warm. Enjoys emoting after winning and loves being a media darling.",abilities:"Capable of transforming into a powerful dragon. Water breath.",weaknesses:"Entirely mortal in her human form.",affiliates:["John","The Crimson Knight","Corvair"],specialAbility:"Anime Transformation: her transformation now includes thick plated dragon plate armor. +10 HP to herself and all positive affiliates / romance partners on the same mission. −10 HP to any hero who disdains her or whom she disdains.",shopLocked:true,baseAvail:true,color:"#4488ff",isFemale:true,dragonDaimyoEffect:true},
  // ── NEW GAME-UNLOCK HEROES ──
  {id:61,title:"Blink",realName:"Alex Mikonos",basePower:4.0,baseHP:46,career:"beginner",cls:"cannon",regenSec:50,functionalAt:20,personality:"A talented Greek artist who seems to be saving the world out of obligation to a former hero parent. Warm with very few people, but fiercely loyal once she opens up.",abilities:"Light manipulation and energy bursts. Slightly above human durability.",weaknesses:"Darkness. Rubber. Paint.",affiliates:["Corvair","The Gummy Bear"],specialAbility:"Flashing Lights: ⅕ chance of halving damage to all other teammates on any mission she's on (does not protect herself).",gameLocked:true,unlockCondition:"Unlocked after defeating the Cult of Fashion.",color:"#ffe066",isFemale:true,blinkEffect:true},
  {id:62,title:"Skull Crusher",realName:"Michael August-Brown",basePower:7.0,baseHP:90,career:"beginner",cls:"tank",regenSec:45,functionalAt:25,personality:"Often agitated, his powers appear to be outside of his control. He struggles not to destroy everything he touches. Working alongside him tends to get other heroes hurt. He has enjoyed training with John and Ironside.",abilities:"High strength, high durability.",weaknesses:"Magic, temperature, and calories. Deals 5 additional damage to one random teammate per mission until special is unlocked.",affiliates:["John","Ironside"],specialAbility:"Finally Mastered Being Gentle: no longer does friendly fire damage to teammates.",gameLocked:true,unlockCondition:"Unlocked after defeating North American Blackout.",color:"#4488ff",isMale:true,skullCrusherFriendlyFire:true},
  {id:63,title:"Eclipso",realName:"Simone Brown",basePower:7.3,baseHP:56,career:"beginner",cls:"cannon",regenSec:55,functionalAt:9,personality:"A sharp and friendly woman who appears more interested in running her bed and breakfast and small farm than saving the world. Very quiet. Tends to show up when her friends ask.",abilities:"Telekinesis, flight, and small-scale atomic control.",weaknesses:"Gets bored often, low pain tolerance. −30% power if no positive affiliates are on the same mission.",affiliates:["Scarlett","Dinosia","Corvair","Shadowmere","The Crimson Knight"],specialAbility:"Sees the Value of the Team: removes the −30% power reduction when she reaches Veteran.",gameLocked:true,unlockCondition:"Unlocked after defeating Blight.",color:"#cc88ff",isFemale:true,eclipsoLonelyPenalty:true},
];
...
const VILLAIN_DEFS=[
  ...
  {id:103,title:"Silphana",realName:"Alexandria Aeros",basePower:8.0,baseHP:65,career:"beginner",cls:"tank",regenSec:35,functionalAt:20,personality:"Former WSPA asset who joined the Knights of Darkness.",abilities:"The Mace of the Corrupted, high durability, speed, strength, dark magic.",weaknesses:"Power waning due to corruption.",affiliates:[],specialAbility:"Mace of the Corrupted deals 10× damage to The Crimson Knight. Once redeemed: Mace deals 10× damage against supervillains.",redeemable:true,threatType:"military",loc:"Eastern Europe",x:290,y:75,reward:55},
