...
const VILLAIN_DEFS=[
  ...
  {id:113,title:"Hydrotheppilies",realName:"K.B. Shrimperson",basePower:5.3,baseHP:49,career:"beginner",cls:"tank",regenSec:40,functionalAt:25,personality:"A gothic shrimperson. Long lost sister of Jean Pierre Shrimperson, bearing witness to historical depictions of ocean-based heroes as jokes and wanting to correct this image.",abilities:"Aquatic powers.",weaknesses:"Weak to fire, high temperatures, electricity.",affiliates:["Hydrothylre"],specialAbility:"Welcome to the Aquatic Jungle: fights at 3× strength underwater.",shopVillain:true,redeemable:true,threatType:"bio",loc:"Ocean",lat:0.0,lng:-30.0,reward:32,portrait:"portraits/Hydrotheppilies.jpg"},
